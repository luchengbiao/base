...
AGResourceVisitor::AGResourceVisitor(void)
{
}
...
BOOL PASCAL AGResourceVisitor::SaveResourceToFile(LPCTSTR lpResourceType, WORD wResourceID, LPCTSTR lpFilePath)
{
...
LPCSTR PASCAL AGResourceVisitor::TransWinPathA(LPCSTR lpWinPath, LPSTR lpStandardPath, SIZE_T cchSize)
{
...
LPCWSTR PASCAL AGResourceVisitor::TransWinPathW(LPCWSTR lpWinPath, LPWSTR lpStandardPath, SIZE_T cchSize)
{
