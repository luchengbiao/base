...
namespace { // private module-only namespace
	...
	class _DummyWebSocket : public easywsclient::WebSockets
	{
	public:
	...
	class _RealWebSocket : public easywsclient::WebSockets
	{
	public:
		...
		virtual void _dispatch(WebSockets::Callback & callable) {
			...
			while (true) {
				...
				else if (ws.opcode == wsheader_type::PONG) { callable("pong"); }
	...
	easywsclient::WebSockets::pointer from_url(const std::string& url, bool useMask, const std::string& origin) {
		char sc[128];
		char host[128];
		int port;
		char path[128];
	...
	return easywsclient::WebSockets::pointer(new _RealWebSocket(ptConnCtx, useMask));
	}
...
namespace easywsclient {
	...
	WebSockets::pointer WebSockets::create_dummy() {
		static pointer dummy = pointer(new _DummyWebSocket);
		return dummy;
	}


	WebSockets::pointer WebSockets::from_url(const std::string& url, const std::string& origin) {
		return ::from_url(url, true, origin);
	}

	WebSockets::pointer WebSockets::from_url_no_mask(const std::string& url, const std::string& origin) {
