...
void NimDataChannel::CreateChannelCb(nim::NIMResCode res_code)
{
	...
	{
		//QLOG_APP(L"NimDataChannel::CreateChannelCb res :{0}") << res_code;
		JoinChannelPrivate(s_channel_id_);
	}
	else
	{
		//QLOG_ERR(L"NimDataChannel::CreateChannelCb res :{0}") << res_code;
...
{
	//QLOG_APP(L"NimDataChannel::JoinChannelCb res :{0}") << res_code;
	int code = 0;
