...
public:
	...
	virtual void OnStuDrawInfos(const std::list<DrawOpInfo>& info_list, bool b_paint = true) = 0;
	virtual void OnTeaDrawInfos(const std::list<DrawOpInfo>& info_list, bool b_paint = true) = 0;
