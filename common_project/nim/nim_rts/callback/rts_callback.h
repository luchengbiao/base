...
public:
	...
	* @return void 无返回值
	*/
	static void StartNotifyCb(const std::string& session_id, int channel_type, const std::string& uid, const std::string& custom_info, const std::string& channel_id);
	...
	* @return void 无返回值
	*/
	static void SyncAckNotifyCallback(const std::string& session_id, int channel_type, bool accept, const std::string& json_ext);
