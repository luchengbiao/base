...
{
	LOG_INFO(L"Chatroom:OnReceiveMsgCallback: {0} from client: {1}") << result.client_msg_id_ << result.from_client_type_;
...
{
	LOG_MSG(L"Chatroom:OnSendMsgCallback: id={0} msg_id={1} code={2}") << result.room_id_ << result.client_msg_id_ << error_code;
...
{
	LOG_MSG(L"Chatroom:OnEnterCallback: id={0} step={1} code={2}") << room_id << step << error_code;
...
{
	LOG_MSG(L"Chatroom:OnExitCallback: id={0} code={1}") << room_id << error_code;
...
{
	LOG_MSG(L"Chatroom:OnNotificationCallback: id={0}") << room_id;
...
{
	LOG_MSG(L"Chatroom:OnRegLinkConditionCallback: id={0} condition={1}") << room_id << condition;
