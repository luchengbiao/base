...
{
public:
	typedef std::function<void(nim::NIMResCode res_code, const std::string& session_id, int channel_type, const std::string& uid, const std::string& channel_id)> StartChannelCallback;
	typedef std::function<void(const std::string& session_id, int channel_type, const std::string& uid, const std::string& channel_id, const std::string& custom_info)> StartNotifyCallback;
	...
	typedef std::function<void(const std::string& session_id, int channel_type, bool accept, const std::string& json_ext)> SyncAckNotifyCallback;
