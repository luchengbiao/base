...
public:
	...
	* @return void 无返回值
	*/
	static void DeviceStatusCb(nim::NIMDeviceType type, uint32_t status, const char* path, const char* json, const void *user_data);
	...
	* @return void 无返回值
	*/
	static void AudioVolumCb(uint64_t time, const char *data, uint32_t size, const char *json_extension, const void *user_data);
};
